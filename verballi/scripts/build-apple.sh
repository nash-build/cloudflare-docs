#!/usr/bin/env bash
# Build verballi as an XCFramework for macOS + iOS (device & simulator).
...
HDR=crates/verballi-ffi/include
...
echo "Add it to your Xcode target and import via the bridging header (verballi.h)."
