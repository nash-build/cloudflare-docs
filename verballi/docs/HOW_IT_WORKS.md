...
and Discord's Krisp integration sit in), and how each maps onto `verballi`. It
...
near-field cues + careful real-time engineering.** `verballi` implements that
